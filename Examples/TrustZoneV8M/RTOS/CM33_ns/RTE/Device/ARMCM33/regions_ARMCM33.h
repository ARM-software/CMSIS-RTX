...
// <i> Device Family Pack (DFP):   ARM::Cortex_DFP@1.1.0

// <h> ROM Configuration
// =======================
// <h> __ROM0 (is rx memory: ROM_S from DFP)
...
// <h> __ROM1 (is rx memory: ROM_NS from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
...
// <h> RAM Configuration
// =======================
// <h> __RAM0 (is rwx memory: RAM_S from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
...
// <h> __RAM1 (is rwx memory: RAM_NS from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
